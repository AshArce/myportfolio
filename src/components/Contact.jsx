...
const Contact = () => {
    ...
    return (
        <section id="contact" className='bg-cover bg-center bg-no-repeat py-20 md:py-24' style={{backgroundImage: "url('/images/contactsBG.png')"}}>
            <div className="container mx-auto py-8 md:py-6 px-4 sm:px-6 lg:px-8">
                ...
                <form ref={form} onSubmit={sendEmail} className="max-w-lg mx-auto">
                    ...
                    <button type="submit" className="bg-gray-400 text-oceanBlue py-2 px-4 rounded-md hover:bg-blueSea">Submit</button>
                </form>
            </div>
        </section>
    );
